...
/* harmony import */ var _movie_detail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./movie-detail.vue?vue&type=style&index=0&lang=scss& */ 30);
...
var _util = __webpack_require__(/*! ../../utils/util.js */ 29);function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var commentSection = function commentSection() {return __webpack_require__.e(/*! import() | components/commentSection */ "components/commentSection").then(__webpack_require__.bind(null, /*! @/components/commentSection.vue */ 153));};var _default =
...

{
  ...
  methods: {
    ...
    //处理数据
    formatData: function formatData(arr) {var _this3 = this;
      var list = [];
      if (arr.length) {
        list = arr.map(function (item) {
          ...
          temp.stars = _this3.formatStar(temp.score);
          temp.calcTime = (0, _util.calcTime)(temp.startTime);
          return temp;
        });
      }
      return list;
    ...
    formatStar: function formatStar(sc) {
      ...
      var url = stars.map(function (item) {
        return item = "/static/images/".concat(item, ".png");
      });
      return url;
    },
    //处理数据
